...
| HA-01 | الحلقات والعضويات | `/halaqas`, عضوياتها وطلابها | Partial | نُفذت إدارة حلقات المعلم (القائمة، الإنشاء، التعديل، التفعيل والإيقاف) عبر طبقات Domain/Data/Presentation ونجحت بوابة Windows CI؛ تبقى إسنادات الطلاب، حالات العضوية، وقوائم الطلاب واختبارات 403/409 الحية كشريحة لاحقة. |
