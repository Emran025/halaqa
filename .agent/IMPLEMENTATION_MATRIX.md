...
| SE-01 | الجلسات والمهام | `/sessions`, realtime, tasks, draft | Partial | نُفذت واجهة RTL للجلسة بأقسام الوسائط المباشرة والمهمة والحضور المؤقت والتسجيل المحلي، وعارض مصحف من `QuranV3.sqlite` المحلي مع تنقل الصفحات واختيار الآية ومتابعة الطرف الآخر وفصل الحضور P2P المؤقت عن التثبيت الرسمي. نجحت بوابة Windows CI. لا يزال محول WebRTC/Media الفعلي المتوافق مع Windows وHost ICE فقط، وتفويض/إشارة WebSocket والتحقق الحي وإدارة المهام والتقارير، أعمالاً لاحقة؛ لا وسائط عبر الخادم. |
