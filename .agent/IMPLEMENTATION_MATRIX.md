...
| RG-01 | الطلبات والمعلمون | `/teachers`, `/student-applications`, `/registration-requests` | Partial | نُفذت مراجعة المعلم لطلبات التسجيل الواردة إلى الحلقة: قائمة مرقمة، فلترة الحالة، قبول، رفض، وطلب استكمال عبر طبقات Domain/Data/Presentation ونجحت بوابة Windows CI. لا تعرض الواجهة قبل القبول إلا ملخص المتقدم العام وتتحقق من إخفاء الحقول الحساسة. تبقى تصفح المعلمين للطالب، تقديم/سحب الطلب، صندوق الطلبات العام للمعلم، والتحقق الحي من 403/409/422 وعمليات الخادم الفعلية لاحقة. |
